function [pts_train, index_train, age_train, pts_test, index_test, age_test, pair_info_train, pair_info_test, age_diff_train, age_diff_test] = FGNET_Loader_vHbL_image_only(fold)
